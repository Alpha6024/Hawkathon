...
export default function VideoCall() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="bg-slate-900 border-b border-slate-800 px-4 py-4 transform transition-all duration-500" style={{ transform: isVisible ? 'translateY(0)' : 'translateY(-100%)', opacity: isVisible ? 1 : 0 }}>
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-xl bg-emerald-600 flex items-center justify-center text-xl shrink-0">🏥</div>
              <div>
                <h1 className="text-white font-bold text-base leading-tight">Video Consultation</h1>
                <p className="text-slate-400 text-xs">Booking ID: {bookingId}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              {patient && (
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="text-center mb-8 transform transition-all duration-700 ease-out" style={{ transform: isVisible ? 'translateY(0)' : 'translateY(30px)', opacity: isVisible ? 1 : 0 }}>
        ...
        <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 mb-6 transform transition-all duration-700 ease-out delay-100" style={{ transform: isVisible ? 'translateY(0)' : 'translateY(30px)', opacity: isVisible ? 1 : 0 }}>
        ...
        {doctorStarted && callLink ? (
          <div className="bg-emerald-900/20 border-2 border-emerald-600 rounded-2xl p-6 text-center mb-4 animate-scaleIn">
            ...
            <button onClick={() => setCallStarted(true)}
              className="w-full py-4 rounded-2xl font-bold text-base bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-900/40 transition-all duration-300 hover:scale-105 animate-pulse">
              📹 Join Call Now
            </button>
          </div>
        ) : (
